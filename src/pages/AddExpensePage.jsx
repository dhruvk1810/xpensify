...
import { Check, IndianRupee, Wallet, CreditCard, Smartphone, Banknote, Landmark, Calendar } from 'lucide-react';
...
// Map category to icon name for transactions display
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      await createTransaction({
        ...
        category,
        type: 'expense',
        icon: categoryIconMap[category] || 'shopping-cart',
        paymentMode,
        status: 'completed',
      });
    ...
    <div className="animate-fade-in">
      ...
      <header className="mb-6">
        ...
        <p className="text-gray-500 dark:text-gray-400 text-sm mt-0.5">
          Record your daily spending to keep track of your finances.
        </p>
      </header>
